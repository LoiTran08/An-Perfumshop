...
<?php
$result = mysqli_query($conn, 'select count(idSP) as total from sanpham where  AnHien=1 and idSP =4 ORDER BY SoLanXem DESC');
...
?>
<div class="row col-md-offset-4"><h3>Top sản phẩm nổi bậc</h3></div>
