 ...
 */
 ...
 <?php
 $result = mysqli_query($conn, 'select count(idSP) as total from sanpham  WHERE AnHien=1 and idSP =4 ORDER BY SoLanMua DESC');
 ...
 ?>
 <div class="row col-md-offset-4"><h3>Top sản phẩm bán chạy nhất </h3></div>
